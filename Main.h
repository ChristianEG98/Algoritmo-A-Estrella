...
void aEstrella(tMatriz& matriz, tLista& abierta, tLista& cerrada, bool& continuar); //algoritmo a* estrella
...
int posicionPadre(tCoor coor, tLista cerrada); //devuelve la posicion de la coordenada que corresponde al padre de la coordenada anterior
